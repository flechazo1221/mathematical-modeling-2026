...
def run_case(module, cfg, latent: dict) -> dict:
    ...
    def record_heat(time_key, old_t, new_t, coeff, storage, grid, dt, boundary_in,
        ...
        # Geometry is an explicit inventory term in the moving-domain heat
        # account: Delta E = Q_conv - Q_lat + Q_geometry.
...
def validations(rows, comparisons, ident_rows, failures) -> list[dict]:
    ...
    return [
        ...
        {"id": "PC-V06-mass-energy-closure", "status": "FAIL", "evidence": "The boundary j_w is derived from total C but no liquid/vapor/bound-water inventory or phase-resolved split is solved."},
        ...
        {"id": "PC-V09-formal-promotion", "status": "BLOCKED", "evidence": "Formal promotion is blocked by failed closure and non-identifiability, irrespective of numerical deltas."},
    ]

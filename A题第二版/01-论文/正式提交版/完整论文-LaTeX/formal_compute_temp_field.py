...
class RunConfig:
    ...
    radial_strategy: str = "two-sided-local"
    # ``prescribed`` keeps the frozen route. ``field`` solves the sensible-
    # heat equation and is used only by the isolated temperature-field revision.
    temp_mode: str = "prescribed"
